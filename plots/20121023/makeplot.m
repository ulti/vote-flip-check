...
% the file must have one line of space-delimited numeric values per precinct.
% some election data will be split between multiple files, in that case
% use the second argument to specify which file to load.
...
ci.county_fn = 'harris';
ci.state_fn = 'tx';
ci.candidates = {'Paul','Gingrich','Davies','Santorum','Roemer','Huntsman','Romney','Bachmann','Uncommitted'};
ci.cmap = [ 0 .8 .8; ... % Paul
            0 .5  0; ... % Gingrich
            1 .5 .2; ... % Davies
           .5 .5  0; ... % Santorum
...
ci.county_fn = 'harris';
ci.state_fn = 'tx';
ci.candidates = {'Hunter','Thompson','Cort','McCain','Paul','Giuliani','Tran','Huckabee','Keyes','Romney','Uncommitted'};
